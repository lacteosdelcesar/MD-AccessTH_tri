(function() {
    ...
    /* @ngInject */
    function NuevaQuejaController(dataservice_qr, authService) {
        var vm = this;
        vm.buzon = {};
        ...
        loadPQR();
        function loadPQR() {
            dataservice_qr.getByEmpleado(authService.getCurrentUser().username).then(function (data) {
                if(data){
                    vm.buzon = data;
        ...
        function resetBuzon() {
            vm.buzon = {
                id: -1,
                cedula_empleado: authService.getCurrentUser().username,
                mensaje: '',
                fecha: new Date(),
                respuesta: null,
